	...
	return (
		<div className="max-w-[1400px] mx-auto  px-6 py-12 space-y-10">
			...
			<div className="flex flex-col lg:flex-row lg:pt-[100px] pt-[80px] lg:pb-[40px] justify-between items-end gap-10">
				...
				{/* Right Paragraphs */}
				<div className="lg:w-[60%] w-full flex justify-start items-end text-sm text-[#0F2850] leading-relaxed gap-[20px]">
			...
			<div className='flex lg:flex-row flex-col py-2 px-2 lg:py-[70px] lg:px-[40px] justify-between item-center border-b-[1px] border-[#A3A3A3] bg-white'>
				...
				<div className=''>
					<p className='lg:text-[32px] text-[20px] text-secondary font-light'>To make the name "Balaji Airvent Systems Private Limited" synonymous with Air Distribution Products.</p>
				</div>
			</div>
			<div className='flex lg:flex-row flex-col py-2 px-2 lg:py-[70px] lg:px-[40px] justify-between item-center border-b-[1px] border-[#A3A3A3] bg-white'>
				...
				<div className='lg:w-[936px] w-full'>
					<p className='lg:text-[32px] text-[20px] text-secondary font-light'>To provide superlative, yet cost effective air management solutions using best quality products and efficient technical support constantly boosted by continuous R&D and innovations.</p>
				</div>
			</div>
		</div>
	)

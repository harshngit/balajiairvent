  ...
  return (
    ...
    >
      <div className="max-w-[1700px] mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <ul className={`hidden md:flex items-center justify-center px-6 py-2 rounded-full ${scrolling ? "bg-white shadow-lg border-gray-200" : "bg-white shadow-lg border-gray-200 text-white"}`}>

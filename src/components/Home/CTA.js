...
const CTA = () => {
	return (
		<div className='banner_cta lg:h-[700px] h-[720px] 2xl:h-[700px] relative'>
			<div className="w-full h-full relative">
				<div className="mx-auto w-full h-full max-w-[1440px] xl:max-w-[1500px] 2xl:max-w-[1700px] relative">
					<div className="absolute lg:bottom-[8rem] bottom-[10rem] right-[2.5rem] lg:right-20 lg:w-[600px] w-[350px] p-[25px] rounded-lg bg-black/20 border border-orange z-10">

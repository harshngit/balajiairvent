...
const AboutHome = () => {
	return (
		<div className="bg-[#0F2850] xxl:px-[220px] xl:px-[96px] md:px-[64px] px-5  py-12 w-full">
			<div className="lg:mx-6 mb-[50px] flex flex-col md:flex-row items-start gap-10">
				...
				<div className="md:w-[70%] w-full">
					<Link href="/aboutus">
					<p className="xl:text-[32px] md:text-[25px] lg:w-[100%] lg:h-auto h-[300px] leading-relaxed bg-gradient-to-b from-[#F0F0F0] via-[#E77853] to-[#0F2850] text-transparent bg-clip-text">

...
const productTabs = [
	...
	{ label: "Datacentre", href: "#data", category: "Data Centre" },
					...
					{activeCategory == "Data Centre" &&
						<>
							<div className="grid grid-cols-1 lg:grid-cols-2 mt-5 px-5 py-5 gap-6">
								...
								<div className="flex flex-col lg:w-[100%] w-full space-y-3 justify-start items-start">
									<h2 className=" bg-blue-gradient text-[28px] md:text-[32px] xl:text-[36px]  text-transparent bg-clip-text">Data Centre</h2>
					...
					{activeCategory == "Air" &&
						<>
							...
							<div className="lg:hidden flex justify-center items-center">
								...
								<div className="flex flex-col lg:w-[100%] w-full space-y-3 justify-start items-start">
									<h2 className=" bg-blue-gradient text-[28px] md:text-[32px] xl:text-[36px]  text-transparent bg-clip-text">Comfort Air Conditioning</h2>
									<p className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">
									...
									<ul className="space-y-2 list-disc list-inside text-secondary">
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">Temperature Control: Maintains indoor temperature in a comfortable range (typically 22–26°C).
										</li>
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">Humidity Regulation: Keeps humidity between 40–60% for optimal comfort.
										</li>
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">Air Quality: Uses filters to reduce dust, allergens, and pollutants.
										</li>
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">
					...
					{activeCategory == "Industries" &&
						<>
							...
							<div className="lg:hidden flex justify-center items-center">
								...
								<div className="flex flex-col lg:w-[100%] w-full space-y-3 justify-start items-start">
									<h2 className=" bg-blue-gradient text-[28px] md:text-[32px] xl:text-[36px]  text-transparent bg-clip-text">Industrial Dampers</h2>
									<p className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">
									...
									<ul className="space-y-2 list-disc list-inside text-secondary">
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">Built with durable materials like stainless steel or coated steel.
										</li>
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">Designed to handle large volumes of air or gas.
										</li>
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">Operated manually or with actuators (electric, pneumatic, or hydraulic).
										</li>
										<li className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">
											Common Types:
										</li>
					...
					{activeCategory == "Fans" &&
						<>
							...
							<div className="lg:hidden flex justify-center items-center">
								...
								<div className="flex flex-col lg:w-[100%] w-full space-y-3 justify-start items-start">
									<h2 className=" bg-blue-gradient text-[28px] md:text-[32px] xl:text-[36px]  text-transparent bg-clip-text">Fans & Ventilation Accessories</h2>
									<p className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">
					...
					{activeCategory == "Fire Door" &&
						<>
							...
							<div className="lg:hidden flex justify-center items-center">
								...
								<div className="flex flex-col lg:w-[100%] w-full space-y-3 justify-start items-start">
									<h2 className=" bg-blue-gradient text-[28px] md:text-[32px] xl:text-[36px]  text-transparent bg-clip-text">Fire doors</h2>
									<p className="text-secondary text-[16px] md:text-[14px] xl:text-[18px]  leading-relaxed">
                                ...
                                <div id={`product-card-${product.id}`} className="w-full xl:w-[31.33%] md:w-[31.333%]">
                                    <div className="group relative h-[220px] md:h-[200px] xl:h-[300px] overflow-hidden rounded-lg bg-white">
                                        <Image
                                            ...
                                            alt={product.name}
                                            fill
                                            className="xl:object-cover object-fill"
                                        />
										...
										<button onClick={() => openDetails(product)} className="inline-flex items-center hover:bg-[#fff] hover:text-secondary gap-2 text-white text-[18px] md:text-[12px] xl:text-[18px] font-light xl:pl-[12px] md:pl-[8px] pr-[12px] pl-[12px] md:py-[8px] rounded-full ring-1 ring-white/40 bg-white/10 backdrop-blur-sm">
												...
												} height={24} className="xl:w-[24px] md:w-[20px] w-[16px]" />
                                            </button>
                                        </div>
                                    </div>
                                      ...
                                      <div className="max-w-[100%] my-[10px] rounded-xl bg-[#F0F0F0] lg:p-[50px] p-[20px] transition-all duration-500 ease-out">
                                        <div className="flex justify-between items-start flex-col lg:flex-row gap-[84px]">
                                                <div className="lg:w-[40%] w-full">
                                                    <div className="relative w-full h-[220px] md:h-[200px] xl:h-[300px] rounded-lg overflow-hidden bg-gray-50">
                                                ...
                                                <div className="lg:w-[60%] w-full">
												   ...
												   {activeCategory == "Data Centre" &&  <p className="text-[16px] md:text-[18px] xl:text-[20px] font-light text-secondary mt-1">Data Center</p>}
												   ...
												   {activeCategory == "Fire Door" &&  <p className="text-[16px] md:text-[18px] xl:text-[20px] font-light text-secondary mt-1">Fire Doors</p>}
                                                    ...
                                                    <div className="mt-[50px] border-b-[1px] border-secondary">
														...
														{["Description", "Key Benefits"].map((tab) => (
															<button key={tab} onClick={() => setActiveTab(tab)} className={`pb-2 text-[18px] md:text-[16px] xl:text-[22px] relative ${activeTab === tab ? "text-secondary font-bold" : "text-secondary"}`}>
                                                                    {tab}
